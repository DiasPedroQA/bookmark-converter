# """
# test_global_tools.py
# ------------------
# Testes unitários para o módulo global_tools.py.
...
# from utils import global_tools
...
#     result: Path = global_tools.validate_path(caminho_generico=str(p))
...
#         global_tools.validate_path(caminho_generico=p)
...
#     """
#     id1: str = global_tools.get_id_path(caminho_generico=temp_file_fixture)
#     id2: str = global_tools.get_id_path(caminho_generico=str(temp_file_fixture.resolve()))
#     assert id1 == id2
...
#     """
#     assert global_tools.get_name_path(caminho_generico=temp_file_fixture) == "testfile.txt"
#     assert global_tools.get_name_path(caminho_generico=temp_hidden_file_fixture) == ".hiddenfile"
...
#     """
#     size: int = global_tools.get_size_path(caminho_generico=temp_file_fixture)
...
#     """
#     size: int = global_tools.get_size_path(caminho_generico=temp_dir_with_files_fixture)
...
#     assert global_tools.get_size_path(caminho_generico=p) == 0
...
#     """
#     dates: dict[str, datetime] = global_tools.get_dates_path(caminho_generico=temp_file_fixture)
...
#     perms: dict[str, bool] = global_tools.get_permissions_path(caminho_generico=file)
#     assert perms["read"] is True
#     assert perms["write"] is True
#     assert isinstance(perms["execute"], bool)


# def test_is_visibel_path(temp_file_fixture: Path, temp_hidden_file_fixture: Path) -> None:
#     """
#     Testa se is_visibel_path identifica arquivos ocultos corretamente.
...
#     """
#     assert not global_tools.is_visibel_path(caminho_generico=temp_file_fixture)
#     assert global_tools.is_visibel_path(caminho_generico=temp_hidden_file_fixture)
