...
# de arquivos texto em global_tools.py.
...
# #     content = "Hello, world!"
# #     global_tools.create_text_file(file_path=file, content=content)

# #     result: str = global_tools.read_text_content(file_path=file)
...
#         global_tools.read_text_content(file_path=non_exist_file)
...
#     dir_path.mkdir()
#     with pytest.raises(FileNotFoundError):
#         global_tools.read_text_content(file_path=dir_path)
...
# #     global_tools.create_text_file(file_path=file, content="new content")
...
# #         global_tools.read_text_content(file_path=file)
...
#     content = "Test write"
#     global_tools.write_text_content(file_path=file, content=content)
...
# #     """
# #     file: Path = tmp_path / "write_test.txt"
# #     global_tools.create_text_file(file_path=file, content="Old content")

# #     new_content = "New content"
# #     global_tools.write_text_content(file_path=file, content=new_content)
...
#         global_tools.write_text_content(file_path=file, content="data")
